...
v1_payments = Blueprint('v1_payments', __name__, url_prefix='/api/v1/payments')
...
@v1_payments.route('/locations/<locationId>/lockers/<lockerId>/code')
...
@v1_payments.route('/<merchantPaymentId>/status')
...
@v1_payments.route('/logs', methods=['GET', 'POST'])
def payments_logs():
